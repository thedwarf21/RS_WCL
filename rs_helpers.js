...
class RSWCLIf extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.expression = this.expression.replace(/^scope\./g, 'document.currentController.scope.')
...
//---------------------------------------------------------------------------------------------------
/**
 * Amélioration et surtout optimisation possible, pour les imbrications de boucles,
 * en faisant hériter de HTMLBaseElement (RS_WCL.js) plutôt que HTMLElement
 *
 * En plus, la classe gagnerait en lisibilité
 */
/* Usage HTML uniquement */
