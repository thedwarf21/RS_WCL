...
const SHADOW_MODE = 'open';           // 'open' ou 'closed' (paramétrage des shadow DOM des composants)
const COMPONENTS_CSS_PATH = 'css';    // Chemin vers le répertoire contenant les fichiers CSS dédiés aux différents composants
...
class RS_WCL {
  ...
  /**********************************************************************************************
   * Ajoute le composant au corps de document, au sein d'un wrapper afin d'y intégrer son style *
   **********************************************************************************************
   * @param  | {HTMLElement} | element       | Le composant à injecter                          *
   * @param  | {string}      | css_file_name | Le nom du fichier CSS de mise en forme           *
   **********************************************************************************************
   * @return   {HTMLElement}   Le wrapper ainsi généré                                          *
   **********************************************************************************************/
  static addShadowElementWithStyle(element, css_file_name) {
    let wrapper = document.createElement("DIV");
    let shadow = wrapper.attachShadow({ mode: SHADOW_MODE });
    RS_WCL.styleShadow(shadow, COMPONENTS_CSS_PATH + '/' + css_file_name);
    shadow.appendChild(element);
    
    // Ajout du wrapper au corps de document avant de le retourner
